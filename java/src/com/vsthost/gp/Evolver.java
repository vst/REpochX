...
public class Evolver extends GRModel {
	...
	String fittestProgram = ((GRCandidateProgram) Stats.get().getStat(StatField.RUN_FITTEST_PROGRAM)).toString();
	Evolver.logger.finest("Ending evolution: " + fittestProgram);
	evolver.onEvolutionEnd(fittestProgram);
